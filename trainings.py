...
def loss_calculator(out_data, data, cce_loss, bce_loss):
    ...
    attr_loss.append(loss_gender.cpu())
    attr_loss.append(loss_head.cpu())
    attr_loss.append(loss_head_colour.cpu())
    attr_loss.append(loss_body.cpu())
    attr_loss.append(loss_body_type.cpu())
    attr_loss.append(loss_body_colour.cpu())
    attr_loss.append(loss_bag.cpu())
    attr_loss.append(loss_leg.cpu())
    attr_loss.append(loss_leg_colour.cpu())
    attr_loss.append(loss_foot.cpu())
    attr_loss.append(loss_foot_colour.cpu())
    attr_loss.append(loss_age.cpu())
