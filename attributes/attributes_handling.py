...
def middle2last_CA_Duke(old_path, save_path):
    ...
    np.save(save_path, new_attr)

old_path = '/home/hossein/SI_attributes/attributes/CA_Duke_train_with_id.npy'
save_path = '/home/hossein/CA_Duke_train_with_id.npy'
middle2last_CA_Duke(old_path, save_path)